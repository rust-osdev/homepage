...
Apart from a few [minor fixes](https://github.com/phil-opp/blog_os/pulls?q=is%3Apr+is%3Aclosed+merged%3A2020-04-01..2020-05-01) (thanks for all the contributions!), April was a quiet month for the [_"Writing an OS in Rust"_](https://os.phil-opp.com/) project. I focused my work this month on the `x86_64` library, the rewrite of the bootloader, and my job search instead. In this regard, I'm excited to announce that I have decided to do Rust-related freelance work for now, which allows me to continue dedicating some of my time to open-source work.
